...
<body onload="LoadFinish()" onload="ControlLogin(<?= $memberid ?>)">
  ...
  <nav class="navbar navbar-expand-md px-3 navbar-light fixed-top bg-light rounded-1" id="navbar">
    <div class="container-fluid">
      <a class="navbar-brand text-light" href="http://localhost/aybu/socialmedia/<?= $translates["home"] ?>" style="font-family: 'Merriweather', serif;"> <img src="images/logo.png" height="60"></a>
