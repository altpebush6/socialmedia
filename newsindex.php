...
<div class="container p-4">
    ...
    <div class="row">
        <div class="col-4 text-start text-light fs-5">
            <small><?= $translates["author"] . ": " . $myNews->NewsAuthor ?></small>
        </div>
        <div class="col-4 text-center text-light fs-5">
            <small style="word-break:break-all;"><?= $translates["source"] . ": " . $myNews->NewsResource ?></small>
        </div>
        <div class="col-4 text-end text-light fs-5">
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-md-none">
                <div class="row">
                    <div class="col-12">
                        <img src="news_images/<?= $myNews->NewsImg ?>" class="rounded-3 w-100">
                    </div>
                    <div class="col-12 mt-4">
                        <p class="fs-4 text-light" style="text-indent:15px;"><?= $myNews->NewsContent ?></p>
                    </div>
                </div>
            </div>
