...
?>
    ...
    <div class="container rounded-3 border-md p-md-5 mt-5" id="container">
        <div class="row p-0 m-0">
            <div class="col-md-9 text-center">
                <div class="row">
                    <div class="col-12 p-2 border-md-bottom">
                        <h2 class="text-light" style="font-family: 'Nanum Gothic', sans-serif;"><?= $club->ClubName ?></h2>
                    </div>
                    <div class="col-12 text-center d-md-none">
                        <img src="club_images/<?= $club->ClubImg ?>" class="rounded-3" style="width:250px;">
                    </div>
                    <div class="col-12 p-3 border-bottom text-light fs-5">
                    ...
                    <div class="col-12 p-3 text-light fs-5">
        ...
        <div class="row mt-3 mb-1 py-4">
            <div class="col-md-8 d-flex d-md-block justify-content-center social-apps">
                <a href="https://www.facebook.com" class="text-light"><i class="fab fa-facebook-square fa-2x mx-2 mx-md-3"></i></a>
                <a href="https://twitter.com" class="text-light"><i class="fab fa-twitter fa-2x mx-2 mx-md-3"></i></a>
                <a href="https://www.instagram.com" class="text-light"><i class="fab fa-instagram fa-2x mx-2 mx-md-3"></i></a>
                <a href="https://web.whatsapp.com" class="text-light"><i class="fab fa-whatsapp fa-2x mx-2 mx-md-3"></i></a>
                <a href="https://www.linkedin.com" class="text-light"><i class="fab fa-linkedin fa-2x mx-2 mx-md-3"></i></a>
                <a href="https://discord.com" class="text-light"><i class="fab fa-discord fa-2x mx-2 mx-md-3"></i></a>
            </div>
            <div class="col-md-4 my-4 my-md-0 d-flex flex-row justify-content-end-md ">
                <?php
                ...
                if (!$ismember) {
                    ...
                    if ($isreqsent) {
                        $joinbutton = '<button type="button" class="btn btn-success" id="cancelreq">' . $translates["sentjoinreq"] . ' <span class="spinner" id="spinnercancelreq"></span></button>';
                    } else {
                        $joinbutton = '<button type="button" class="btn btn-success" id="joinclub">' . $translates["sendjoinreq"] . ' <span class="spinner" id="spinnerjoinclub"></span></button>';
                    } ?>
                    ...
                    if ($isspammed) {
                        $spambutton = '<button type="button" class="btn btn-danger ms-2" id="cancelspam">' . $translates["spammedclub"] . ' <span class="spinner" id="spinnercancelspam"></span></button>';
                    } else {
                        $spambutton = '<button type="button" class="btn btn-danger ms-2" id="spamclub">' . $translates["spamclub"] . ' <span class="spinner" id="spinnerspamclub"></span></button>';
                    } ?>
                    <?= $spambutton ?>

                <?php } else { ?>
                    <button type="button" class="btn btn-dark" id="leaveclub"><?= $translates["leaveclub"] ?></button>
                    <?php
                    $isspammed = $db->getData("SELECT * FROM clubspams WHERE SpammerID = ? AND ClubID = ?", array($memberid, $part));
                    if ($isspammed) {
                        $spambutton = '<button type="button" class="btn btn-danger ms-2" id="cancelspam">' . $translates["spammedclub"] . ' <span class="spinner" id="spinnercancelspam"></span></button>';
                ...
                <div class="col-12 m-0 p-0">
                    <ul class="nav nav-tabs nav-fill nav-justified mt-3" id="clubTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="posts_container-tab" data-bs-toggle="tab" data-bs-target="#posts_container" type="button" role="tab"><?= $translates["posts"] ?></a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="events-tab" data-bs-toggle="tab" data-bs-target="#events" type="button" role="tab"><?= $translates["Events"] ?></a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="members-tab" data-bs-toggle="tab" data-bs-target="#members" type="button" role="tab"><?= $translates["members"] ?></a>
                        </li>
                    </ul>
                </div>
    ...
    <?php } else { ?>
        <div class="container border p-4 mt-5" style="min-height: 57vh;">
            <div class="row p-0 m-0">
                <div class="col-4" id="empty"></div>
                <div class="col-12 col-md-4 my-2 my-md-0 ms-auto text-center">
                    <h2 class="text-light"><?= $translates["allclubs"] ?></h2>
                </div>
            ...
            <div class="row p-2 justify-content-center" id="all_clubs">
                ...
                ?>
                    <div class="col-md-3 p-3 m-2" style="border:2px solid rgba(255, 255, 255, 0.281);box-shadow:1px 1px 5px white;">
                        <div class="row">
