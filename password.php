    ...
    <div class="col-12">
      ...
      <form method="post" id="form_pass">
        <div class="row mb-4 justify-content-center">
          ...
          <div class="col-8">
            <input class="form-control" type="password" placeholder="<?= $translates["pass"] ?>" name="pass_old" id="pass_old_admin">
          </div>
        </div>
        ...
        <div class="row my-4 justify-content-center">
          ...
          <div class="col-8">
            <input class="form-control" type="password" placeholder="<?= $translates["newpass"] ?>" name="pass_new" id="pass_new_admin">
          </div>
        </div>
        ...
        <div class="row my-4 justify-content-center">
          ...
          <div class="col-8">
            <input class="form-control" type="password" placeholder="<?= $translates["newpassagain"] ?>" name="pass_new_again" id="pass_new_again_admin">
          </div>
        </div>
