    ...
    <form id="form_posting" method="post" enctype="multipart/form-data" class="px-3">
      ...
      <div class="row mt-3">
        <div class="col-10 mx-auto">
          <button type="submit" class="btn w-100 rounded-3 border fs-5 shadow btn-post" name="submitpost" id="submitpost"><?= $translates["shareit"] ?> <span class="spinner" id="spinnershare"></span></button>
        </div>
      </div>
    </form>
  </div>
      ...
      <div class="border p-3 col-md-10 mx-auto offset-md-1 py-4 post bg-light shadow" style="border-radius: 15px;">
        ...
        <div class="d-none" id="addpartul_<?= $post_ID ?>">
          <form id='form_edit<?= $post_ID ?>' class='form_edit' idsi="<?= $post_ID ?>" method='post' enctype='multipart/form-data'>
            ...
            <div class="row my-3">
              <div class="col-10 mx-auto">
                <button type="submit" class="btn w-100 rounded-3 border fs-5 saveedit shadow btn-post" name='saveedit' id='saveedit<?= $post_ID ?>'><?= $translates["shareit"] ?> <span class="spinner" id="spinnershare"></span></button>
              </div>
            </div>
          </form>
        </div>
