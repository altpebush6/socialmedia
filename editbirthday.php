<form method="post" id="form_<?= $items->NavForm ?>">
    ...
    <td class="py-3 px-5">
        <div class="col-10 offset-1">
            <input class="form-control form-control-sm shadow" type="date" name="<?= $items->NavForm ?>" id="<?= $items->NavForm ?>_input" value="<?= $db->getColumnData("SELECT $getItem FROM memberabout WHERE MemberID = ?", array($memberid)) ?>">
        </div>
    </td>
